...
void
GammaPlugin::changedParam(const OFX::InstanceChangedArgs &args,
...
void
GammaPluginFactory::describe(OFX::ImageEffectDescriptor &desc)
{
    // basic labels
...
void
GammaPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
