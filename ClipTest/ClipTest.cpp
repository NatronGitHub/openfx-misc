...
void
ClipTestPlugin::changedParam(const OFX::InstanceChangedArgs &args,
...
void
ClipTestPluginFactory::describe(OFX::ImageEffectDescriptor &desc)
{
    // basic labels
...
void
ClipTestPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
