...
public:
    Log2LinProcessorBase(OFX::ImageEffect &instance,
...
private:
    ...
    void setupAndProcess(Log2LinProcessorBase &, const OFX::RenderArguments &args);
...
void
Log2LinPlugin::render(const OFX::RenderArguments &args)
{
    //std::cout << "render!\n";
...
template<int nComponents>
void
Log2LinPlugin::renderForComponents(const OFX::RenderArguments &args)
{
...
template <class PIX, int nComponents, int maxValue>
void
Log2LinPlugin::renderForBitDepth(const OFX::RenderArguments &args)
{
                                               ...
                                               OFX::ContextEnum context)
{
    ...
    {
        OFX::RGBParamDescriptor* param = desc.defineRGBParam(kParamBlack);
    ...
    {
        OFX::RGBParamDescriptor* param = desc.defineRGBParam(kParamWhite);
    ...
    {
        OFX::RGBParamDescriptor* param = desc.defineRGBParam(kParamGamma);
