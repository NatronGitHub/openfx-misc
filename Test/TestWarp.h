...
#ifndef Misc_TestWarp_h
#define Misc_TestWarp_h
...
void getTestWarpPluginID(OFX::PluginFactoryArray &ids);

/** @brief The plugin that does our work */
class TestWarpPlugin
...
public:
    /** @brief ctor */
    TestWarpPlugin(OfxImageEffectHandle handle);

    virtual ~TestWarpPlugin();
...
private:
    ...
    OFX::Clip *_dstClip;
    OFX::Clip *_srcClip;
    OFX::Double2DParam *_from;
    OFX::Double2DParam *_to;
