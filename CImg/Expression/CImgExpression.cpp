...
#define kPluginDescriptionMarkdown "\n" \
    ...
    "        * '`date(attr,path)`' returns the date attribute for the given 'path' (file or directory), with __'attr'__ being __\\{ 0=year \\| 1=month \\| 2=day \\| 3=day of week \\| 4=hour \\| 5=minute \\| 6=second \\}__.\n" \
