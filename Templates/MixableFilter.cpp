...
#define kPluginName "MixableFilter"
#define kPluginGrouping "Filter"
#define kPluginDescription "A generic maskable filter template."
#define kPluginIdentifier "net.sf.openfx.MixableFilter"
// History:
    ...
    void process(const OfxRectI& procWindow, const OfxPointD& rs)
    {
        ...
        for (int y = procWindow.y1; y < procWindow.y2; y++) {
            ...
            for (int x = procWindow.x1; x < procWindow.x2; x++) {
                ...
                tmpPix[2] = (float)t_b;
                tmpPix[3] = (float)t_a;
                ofxsPremultMixPix<PIX, nComponents, maxValue>(tmpPix, _premult, _premultChannel, srcPix, (float)_mix, dstPix);
...
# endif
    ...
    processor.process();
} // MixableFilterPlugin::setupAndProcess
                                ...
                                , int& /*view*/, std::string& /*plane*/)
{
    ...
    return false;
} // MixableFilterPlugin::isIdentity
...
static MixableFilterPluginFactory p(kPluginIdentifier, kPluginVersionMajor, kPluginVersionMinor);
